...
from splitwise.desktop.bills_widget import BillDialog
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, userData: UserData, *args):
        ...
        self.reviewBill.clicked.connect(self.onReviewBill)
    ...
    def onReviewBill(self):
        # selections = self.billView.selectionModel().selectedRows(0)
        # if selections:
        bill = BillDialog(self)
        bill.exec()
